...
;/*****************************************************
; * 函数名：VmxRestoreSegmentRegisters
; * 功能：恢复DS、ES、FS段寄存器
; * 参数：
...
;*****************************************************/
VmxRestoreSegmentRegisters PROC
    mov     ds, cx              ; 恢复 DS
    mov     es, cx              ; 恢复 ES
    mov     fs, dx              ; 恢复 FS
    ret
VmxRestoreSegmentRegisters ENDP
